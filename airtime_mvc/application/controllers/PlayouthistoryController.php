...
class PlayouthistoryController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->view->headScript()->appendFile($staticBaseDir.'js/datatables/plugin/TableTools-2.1.5/js/ZeroClipboard.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
        $this->view->headScript()->appendFile($staticBaseDir.'js/datatables/plugin/TableTools-2.1.5/js/TableTools.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
        ...
        $this->view->headScript()->appendFile($staticBaseDir.'js/bootstrap-datetime/bootstrap-datetimepicker.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
        ...
        $this->view->headScript()->appendFile($staticBaseDir.'js/airtime/playouthistory/historytable.js?'.$CC_CONFIG['airtime_version'],'text/javascript');

        $this->view->headLink()->appendStylesheet($staticBaseDir.'css/bootstrap-datetimepicker.min.css?'.$CC_CONFIG['airtime_version']);
        $this->view->headLink()->appendStylesheet($staticBaseDir.'js/datatables/plugin/TableTools-2.1.5/css/TableTools.css?'.$CC_CONFIG['airtime_version']);
        $this->view->headLink()->appendStylesheet($staticBaseDir.'css/jquery.ui.timepicker.css?'.$CC_CONFIG['airtime_version']);
        $this->view->headLink()->appendStylesheet($staticBaseDir.'css/playouthistory.css?'.$CC_CONFIG['airtime_version']);
        $this->view->headLink()->appendStylesheet($staticBaseDir.'css/history_styles.css?'.$CC_CONFIG['airtime_version']);
