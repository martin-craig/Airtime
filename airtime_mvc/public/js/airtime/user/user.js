...
function rowClickCallback(row_id){
      $.ajax({ url: baseDir+'User/get-user-data/id/'+ row_id +'/format/json', dataType:"json", success:function(data){
        populateForm(data.entries);
	  }});    
}

function removeUserCallback(row_id, nRow){
      $.ajax({ url: baseDir+'User/remove-user/id/'+ row_id +'/format/json', dataType:"text", success:function(data){
...
function populateUserTable() {
    $('#users_datatable').dataTable( {
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": baseDir+"User/get-user-data-table-info/format/json",
