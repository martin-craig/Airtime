function setWatchedDirEvents() {
    ...
    $('#storageFolder-selection').serverBrowser({
        ...
        knownPaths: [],
        imageUrl: 'img/icons/',
        systemImageUrl: staticBaseDir+'css/img/',
        handlerUrl: baseDir+'Preference/server-browse/format/json',
    ...
    $('#storageFolder-ok').click(function(){
        ...
        if(confirm($.i18n._("Are you sure you want to change the storage folder?\nThis will remove the files from your Airtime library!"))){
            url = baseDir+"Preference/change-stor-directory";
    ...
    $('#watchedFolder-ok').click(function(){
        ...
        url = baseDir+"Preference/reload-watch-directory";
    ...
    $('.selected-item').find('.ui-icon-refresh').click(function(){
        ...
        $.get(baseDir+"Preference/rescan-watch-directory", {format: "json", dir: folder});
    });
    ...
    $('.selected-item').find('.ui-icon-close').click(function(){
        if(confirm($.i18n._("Are you sure you want to remove the watched folder?"))){
            ...
            url = baseDir+"Preference/remove-watch-directory";
